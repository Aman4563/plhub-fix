...
//   color: ${({ theme }) => (theme === themeModes.dark ? "#fff" : "#000")};
//   border-radius: 8px;
...
//   color: ${({ theme }) => (theme === themeModes.dark ? "#000" : "#fff")};
//   animation: ${({ success }) => (success === "true" ? successAnimation : "none")} 0.5s ease;
// `;
...
//  * - A user feedback submission form with animated success feedback and error handling.
//  *
//  * @component
//  */
// const FeedbackForm = () => {
...
//           setSuccess(true);
//           setTimeout(() => setSuccess(false), 500); // Reset success animation
//         }
//         if (err) {
